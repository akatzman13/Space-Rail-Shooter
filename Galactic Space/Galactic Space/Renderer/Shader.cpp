...
bool CShader::Initialize(ID3D11Device* device, HWND hwnd)
{
	bool result;

	// Initialize the vertex and pixel shaders.
	result = InitializeShader(device, hwnd, L"../Galactic Space/Resources/Shaders/ColorVS.fx", L"../Galactic Space/Resources/Shaders/ColorPS.fx");
	if(!result)
	{
		return false;
	}
...
bool CShader::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFileName)
{
	HRESULT result;
	...
	if(FAILED(result))
	{
		...
		{
			WriteToConsole("Missing Shader File", ERRORS);
		}
